...
void UCombatComponent::TraceUnderCrosshairs(FHitResult& TraceHitResult)
{
	...
	if (bScreenToWorld)
	{
		...
		// set tracehit result to something if trace hits nothing(sky or very far objects)
...
void UCombatComponent::SetHUDCrosshairs(float DeltaTime)
{
	...
	if (Controller)
	{
		...
		if (HUD)
		{
			...
			CrosshairVelocityFactor = FMath::GetMappedRangeValueClamped(WalkSpeedRange, VelocityMultiplierRange, Velocity.Size() * 0.8f);
...

			{
				...
				OnTargetFactor = FMath::FInterpTo(OnTargetFactor, 0.2f, DeltaTime, 30.f);
...

			{
				...
				OnTargetFactor = FMath::FInterpTo(OnTargetFactor, 0.f, DeltaTime, 30.f);
