...
void ABlasterCharacter::MulticastElim_Implementation(bool bPlayerLeftGame)
{
	...
	if (BlasterPlayerController)
	{
		...
		BlasterPlayerController->CleanWeaponIcon();
	}
	bElimmed = true;
	PlayElimMontage();
...
void ABlasterCharacter::PlayHitParticle() {
	if (PlayerImpactParticles)
	{
		UGameplayStatics::SpawnEmitterAtLocation(GetWorld(), PlayerImpactParticles, this->GetActorLocation());
	}
	if (PlayerImpactSound)
	{
		UGameplayStatics::PlaySoundAtLocation(this, PlayerImpactSound, this->GetActorLocation());
	}
}
